...
<div id="account__subitem">
  <a id="account__subitem1" href="<?php echo bp_loggedin_user_domain() . 'messages/'; ?>">
    ...
    <div class="menu__content">Messages<div class="circle" style="width: 15px; height: 15px; line-height: 14px;"><?php echo (isset($bp->loggedin_user->id) ? count( bp_get_total_unread_messages_count( $bp->loggedin_user->id ) ) : 0); /* Error Fix by CodePinch */ ?></div></div>
  </a>
  <a id="account__subitem2" href="<?php echo bp_loggedin_user_domain() . 'friends/'; ?>">
    <div class="menu__icon menu__icon--empty"></div>
    <div class="menu__content">Requests<div class="circle" style="width: 15px; height: 15px; line-height: 14px;"><?php echo (isset($bp->loggedin_user->id) ? count( bp_friend_get_total_requests_count( $bp->loggedin_user->id ) ) : 0); /* Error Fix by CodePinch */ ?></div></div>
  </a>
</div>
<?php endif; ?>
...
<?php else : ?>
		<div id="container" style="position:relative; width: 100%; margin: auto; height: auto;">
<?php endif; ?>