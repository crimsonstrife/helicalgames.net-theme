...
<link rel="stylesheet" href="/public/helicalnet/css/normalize.css">
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
<link href="/public/helicalnet/css/slider.css" rel="stylesheet" type="text/css">
<link rel="apple-touch-icon" sizes="57x57" href="/public/helicalnet/imgs/icons/favicons/apple-touch-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="/public/helicalnet/imgs/icons/favicons/apple-touch-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="/public/helicalnet/imgs/icons/favicons/apple-touch-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="/public/helicalnet/imgs/icons/favicons/apple-touch-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="/public/helicalnet/imgs/icons/favicons/apple-touch-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="/public/helicalnet/imgs/icons/favicons/apple-touch-icon-120x120.png">
<link rel="apple-touch-icon" sizes="144x144" href="/public/helicalnet/imgs/icons/favicons/apple-touch-icon-144x144.png">
<link rel="apple-touch-icon" sizes="152x152" href="/public/helicalnet/imgs/icons/favicons/apple-touch-icon-152x152.png">
<link rel="apple-touch-icon" sizes="180x180" href="/public/helicalnet/imgs/icons/favicons/apple-touch-icon-180x180.png">
<link rel="icon" type="image/png" href="/public/helicalnet/imgs/icons/favicons/favicon-32x32.png" sizes="32x32">
<link rel="icon" type="image/png" href="/public/helicalnet/imgs/icons/favicons/favicon-194x194.png" sizes="194x194">
<link rel="icon" type="image/png" href="/public/helicalnet/imgs/icons/favicons/favicon-96x96.png" sizes="96x96">
<link rel="icon" type="image/png" href="/public/helicalnet/imgs/icons/favicons/android-chrome-192x192.png" sizes="192x192">
<link rel="icon" type="image/png" href="/public/helicalnet/imgs/icons/favicons/favicon-16x16.png" sizes="16x16">
<link rel="manifest" href="/public/helicalnet/imgs/icons/favicons/manifest.json">
<link rel="mask-icon" href="/public/helicalnet/imgs/icons/favicons/safari-pinned-tab.svg" color="#6699ff">
<meta name="msapplication-TileColor" content="#da532c">
<meta name="msapplication-TileImage" content="/public/helicalnet/imgs/icons/favicons/mstile-144x144.png">
...
#slashadmin_eucookielaw.cl_bottom {
	...
	#slashadmin_eucookielaw.cl_bottom.cl_visible {
		margin-bottom: 0;
	}
...
/* Dark (default) */
#slashadmin_eucookielaw.cl_dark {
	background:#333333;
	color: #fff;
  box-shadow: 0px 0px 0px #000;
}
#slashadmin_eucookielaw.cl_dark #slashadmin_cookiemore {
	color: #fff;
}
...
<li class="nav_logo h1" style="height: 52px; padding-left: 25px; padding-bottom: 3px;">
			...
			<input class="btn_search ir" type="image" name="search-submit" id="search-submit" style="position:relative; float:right;" value="<?php esc_attr_e( 'Search', 'buddypress', 'support' ); ?>" src="/public/helicalnet/imgs/icons/sprite_nav_search_v2.png"/>
 ...
 <?php echo bp_search_form_type_select(); ?>
            ...
            <?php my_bp_adminbar_notifications_menu()?></a>
					...
					<div class="nav-bucket">
						<a class="exempt" id="btn_signUp" href="/logout/">Sign Out</a>
					</div>
			</li
            ><?php else : ?>
...
<?php else : ?>
  ...
  <div class="user_info" style="padding-left: 5px; padding-top: 2px;">
  	<div class="user__avatar">
		<img src="https://www.gravatar.com/avatar/21768c94207461357618040aaa8be7a2?s=40&r=pg&d=mm" />
	</div>
...
<div id="account__subitem">
  <a id="account__subitem1" href="<?php echo bp_loggedin_user_domain() . 'messages/'; ?>">
    ...
    <div class="menu__content">Messages<div class="circle" style="width: 15px; height: 15px; line-height: 14px;"><?php echo (isset($bp->loggedin_user->id) ? count( bp_get_total_unread_messages_count( $bp->loggedin_user->id ) ) : null); /* Error Fix by CodePinch */ ?></div></div>
  </a>
  <a id="account__subitem2" href="<?php echo bp_loggedin_user_domain() . 'friends/'; ?>">
    <div class="menu__icon menu__icon--empty"></div>
    <div class="menu__content">Requests<div class="circle" style="width: 15px; height: 15px; line-height: 14px;"><?php echo (isset($bp->loggedin_user->id) ? count( bp_friend_get_total_requests_count( $bp->loggedin_user->id ) ) : null); /* Error Fix by CodePinch */ ?></div></div>
  </a>
</div>
<?php endif; ?>
...
<?php else : ?>
		<div id="container" style="position:relative; width: 95%; max-width: 1250px; margin: 62px auto; height: auto;">
<?php endif; ?>